...
public class NinjaAnimation
{
    ...
    /// <summary>
    /// Text to display in a speech bubble while the move plays. Empty for
    /// idle/no-yell moves. Set explicitly per animation since "Shoryuken"
    /// and similar don't trivially uppercase to anything yellable.
    /// </summary>
